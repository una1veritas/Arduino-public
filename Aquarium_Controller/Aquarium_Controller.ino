...
ST7032i i2clcd;
RTC i2crtc(RTC::CHIP_MAXIM_DS1307);
...
/*
      i2clcd.print(" ");
      i2clcd.print(i2crtc.date&0x3f, HEX);
      i2clcd.print('/');
      i2clcd.print(i2crtc.date>>8&0x1f, HEX);
      i2clcd.print(" ");
*/
      i2clcd.print(" ");
      i2clcd.print(status.bp, 1);
      i2clcd.print(" ");

      i2clcd.setCursor(0,1);
      i2clcd.print(status.temp, 1);
      i2clcd.print("C ");
      i2clcd.print(status.humid, 1);
      i2clcd.print("% ");
    }
  }
  ...
  if ( millis() - status.lastsense >= 2400 && millis() - status.lastdisplay < 100) {
    ...
    sht15.measure();
    status.humid = sht15.calcHumi();
    status.temp = sht15.calcTemp();
  }
