...
const uint16_t rom0000_size = (1<<8);
const uint8_t rom0000[rom0000_size] PROGMEM = {
0x21, 0x4f, 0x00, 0xcd, 0x46, 0x00, 0xdb, 0x00, 
0xfe, 0xff, 0x20, 0xfa, 0xdb, 0x01, 0x32, 0x5e, 
0x00, 0xfe, 0x1a, 0x28, 0x07, 0xd3, 0x02, 0xcd, 
0x1e, 0x00, 0x18, 0xea, 0x76, 0x47, 0xcb, 0x3f, 
0xcb, 0x3f, 0xcb, 0x3f, 0xcb, 0x3f, 0xfe, 0x0a, 
0x30, 0x06, 0xc6, 0x30, 0xd3, 0x02, 0x18, 0x04, 
0xc6, 0x41, 0xd3, 0x02, 0x78, 0xe6, 0x0f, 0xfe, 
0x0a, 0x30, 0x06, 0xc6, 0x30, 0xd3, 0x02, 0x18, 
0xf3, 0xc6, 0x41, 0xd3, 0x02, 0xc9, 0x0e, 0x02, 
0x7e, 0xa7, 0xc8, 0xed, 0xa3, 0x18, 0xf9, 0x48, 
0x69, 0x2c, 0x20, 0x49, 0x27, 0x6d, 0x20, 0x5a, 
0x38, 0x30, 0x21, 0x0a, 0x0d, 0x00, 0x17, 
};
...
void setup() {
  ...
  while (!Serial) {}
  Serial1.begin(57600);
  Serial1.println("Hello to Serial1.");
...
uint8_t io_out(uint8_t port, uint8_t data) {
  switch(port) {
    case 0x01:
    case 0x02:
      Serial1.write(data);
