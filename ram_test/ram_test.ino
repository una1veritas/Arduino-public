...
/*
 * Arduino: 1.8.3 (Mac OS X), Board: "Arduino Pro or Pro Mini, ATmega328 (5V, 16 MHz)"

`__vector_13' referenced in section `.vectors' of /Applications/Arduino.app/Contents/Java/hardware/tools/avr/bin/../lib/gcc/avr/4.9.2/../../../../avr/lib/avr5/crtatmega328p.o: defined in discarded section `.text' of libraries/ram/ram.c.o (symbol from plugin)
