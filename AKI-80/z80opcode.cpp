...
const char code_18[] PROGMEM = "JR nn"; 
...
const char code_20[] PROGMEM = "JR NZ,nn"; 
...
const char code_28[] PROGMEM = "JR Z,nn"; 
...
const char code_6E[] PROGMEM = "LD L,(HL)"; 
...
const char code_76[] PROGMEM = "HLT"; 
...
char * opcode(uint16_t code, char * buf) {
  int i = code & 0xff;
