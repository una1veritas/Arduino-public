...
static prog_uchar /* unsigned char*/ keywords[] PROGMEM = {
  'L','I','S','T'+0x80,
  'L','O','A','D'+0x80,
  'N','E','W'+0x80,
  'R','U','N'+0x80,
...
static prog_uchar /*unsigned char*/ func_tab[] PROGMEM = {
  'P','E','E','K'+0x80,
  'A','B','S'+0x80,
  'A','R','E','A','D'+0x80,
  'D','R','E','A','D'+0x80,
...
static prog_uchar /*unsigned char*/ to_tab[] PROGMEM = {
  'T','O'+0x80,
  0
};

static prog_uchar /*unsigned char*/ step_tab[] PROGMEM = {
  'S','T','E','P'+0x80,
  0
};

static prog_uchar /*unsigned char*/ relop_tab[] PROGMEM = {
  '>','='+0x80,
  '<','>'+0x80,
  '>'+0x80,
  '='+0x80,
...
static prog_uchar /*unsigned char*/ highlow_tab[] PROGMEM = { 
  'H','I','G','H'+0x80,
  'H','I'+0x80,
  'L','O','W'+0x80,
  'L','O'+0x80,
...
#ifndef kAutoConf
static prog_uchar /*unsigned char*/ inputoutput_tab[] PROGMEM = {
  'I','N','P','U','T'+0x80,
  'I','N'+0x80,
  'I'+0x80,
  'O','U','T','P','U','T'+0x80,
...
/***************************************************************************/
static void scantable(prog_uchar /*unsigned char*/ *table)
{
  int i = 0;
  table_index = 0;
  while(1)
  {
    ...
    if( pgm_read_byte(table /*[0]*/) == 0)
      return;

    // Do we match this character?
    if(txtpos[i] == pgm_read_byte(table /*[0]*/))
    {
      i++;
      table++;
    }
    else
    {
      ...
      if(txtpos[i]+0x80 == pgm_read_byte(table /*[0]*/))
      {
      ...
      while((pgm_read_byte(table /*[0]*/) & 0x80) == 0)
        table++;
