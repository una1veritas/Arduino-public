...
//
ST7032i::ST7032i(I2CBUSCLASS & bus,  GPIOPin bklt, GPIOPin rst) : wire(bus), pin_bklight(bklt), pin_reset(rst){
	_numlines = 2;
	_numcolumns = 16;
	_position = 0;
...
void ST7032i::clear() {
	...
	_position = 0;
	delay(200);  // this command takes a long time!
}
