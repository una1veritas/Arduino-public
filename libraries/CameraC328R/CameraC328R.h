...
//
    bool printJPEGPicture(Stream & outstream, PictureType pictureType, uint16_t processDelay );
    bool outputRawPicture(PictureType, Stream &, uint16_t );
//
